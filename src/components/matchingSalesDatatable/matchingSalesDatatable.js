...
import "../matchingSalesDatatable/matchingSalesDatatable.css";
import { DataTable } from "primereact/datatable";
import { Column } from "primereact/column";
import { FilterMatchMode } from "primereact/api";

const MatchingSalesDatatable = (props) => {
  const { salesTableData, isLoading, setselectedMatchingSales} = props; 
  ...
  useEffect(() => { 
    setselectedMatchingSales(selectedDatas);
  }, [selectedDatas, setselectedMatchingSales]);
...
export default MatchingSalesDatatable;
